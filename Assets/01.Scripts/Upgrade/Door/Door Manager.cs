...
public class DoorManager : MonoBehaviour
{
    ...
    //public bool autoCloseEnabled = true; // ✅ elevtest에서 자동닫힘을 제어할 수 있게
    //public bool triggerEnabled = true;   // ✅ 트리거 자동열림 방지용
    ...
    //{
    //    // ✅ elevtest에서 triggerEnabled = false로 설정 시 자동 열림 방지
    //    if (!triggerEnabled) return;

    //    if (other.CompareTag("Player"))
    //    {
    //        Debug.Log("🚪 플레이어 감지됨 → 문 자동 열림");
    //        OpenDoors();
    //    }
    //}
